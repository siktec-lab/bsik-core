...
class CoreSettings {
    ...
    public static array $path = [
        ...
        "manage-core"       => ROOT_PATH.DS."manage".DS."core",
        ...
        "manage-api"        => ROOT_PATH.DS."manage".DS."core".DS."Api".DS."CoreApiEndPoints.php",
        "manage-components" => ROOT_PATH.DS."manage".DS."core".DS."Builder".DS."CoreComponents.php",
